...
export function AutoEqConstraints() {
  ...
  return (
    <section id="autoeq-settings" className="autoeq-settings" aria-label="AutoEQ Settings">
      <div className="settings-row" role="group" aria-label="AutoEQ frequency range">
        <span>Frequency</span>
        <NumberField
          label="From"
      ...
      <div className="settings-row" role="group" aria-label="AutoEQ gain range">
        <span>Gain</span>
        <NumberField
          label="Min"
      ...
      <div className="settings-row" role="group" aria-label="AutoEQ Q range">
        <span>Q</span>
        <NumberField
          label="Min"
      ...
      <div className="settings-row settings-row--limit" role="group" aria-label="AutoEQ filter limit">
        <span>Max Filters</span>
        <NumberField
          label="Max"
